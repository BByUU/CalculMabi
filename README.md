...
技能修練計算到達目標 Rank 前的各階，可選每階練到 30% 或 100%。聚能預設單階累積成功率 99%，各階可獨立勾選藥水或手填次數。星塵可選期望值或累積成功率，任務基礎獎勵固定各 2 個，圖騰與藥水互斥。特性一律計算到 Lv.10，舊版儲存的目標等級會被忽略；預設全部由 Lv.1 起算：修行 7 項需 48,300 點、33 週，挑戰與交感各 6 項需 41,400 點、28 週，三類同時累積，由修行決定完成週數。週數不計入每日 AP 轉換與目前等級計點條已注入的點數。
